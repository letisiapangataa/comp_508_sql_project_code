...
SELECT * FROM PHOTO_SESSION_DATABASE;
...
SELECT * FROM LOCATION_PHOTOGRAPHY_SESSION;
...
SELECT * FROM PHOTOGRAPH_EXTRACTED_PHOTO;
SELECT * FROM EXTRACTED_PHOTO;
...
SELECT CUSTOMER_ID AS "CUSTOMER ID", FIRST_NAME || ' ' || LAST_NAME AS "CUSTOMER NAME", EMAIL_ADDRESS AS "CUSTOMER EMAIL ADDRESS", PHONE_NO AS "CUSTOMER PHONE NUMBER", PAYMENT_DETAILS AS "PAYMENT DETAILS" 
FROM CUSTOMERS 
...
STREET || ', ' || CITY || ', ' || COUNTRY AS "DELIVERY ADDRESS", 
